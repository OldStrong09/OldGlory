(()=>{
 ...
 function run(bars=[],strategy,opts={}){
  ...
  for(let i=1;i<bars.length;i++){
   const b=bars[i],prev=bars[i-1],signal=typeof strategy==='function'?strategy(prev,b,i):null;
